...
public class RecordDao {
    ...
    public  List<Map<String,Object>>  query(int typeId,String keyWork) throws SQLException {
        ...
        List<Map<String,Object>> data =queryRunner.query(conn,sb.toString(),new MapListHandler());
        DBHelper.close(conn);
        return data;
    }
...
//        }
        try {
            List<Record> recordByBookId = new RecordDao().getRecordByBookId(1);
            System.out.println(recordByBookId);
