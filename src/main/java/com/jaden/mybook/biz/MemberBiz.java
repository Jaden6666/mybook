...
import com.jaden.mybook.dao.MemberDao;
import com.jaden.mybook.dao.MemberTypeDao;
...
public class MemberBiz {
  ...
  //不改金额的biz
  public int modify(long id,String name,String pwd,long typeId,String tel,String idNumber){
    int count = 0;
    try {
      count = memberDao.modify(id,name,pwd,typeId,tel,idNumber);
    } catch (SQLException throwables) {
      throwables.printStackTrace();
    }
    return count;
  ...
  public List<Member> getAll(){
    MemberTypeDao typeDao = new MemberTypeDao();//用的不多，方法中
