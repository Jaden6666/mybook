                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">图书查询 > 书籍详情</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <form action="" method="">
                                                <table width="100%"class="cont">
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td></td>
                                                        <td colspan="3"><input class="btn" type="button" value="返回" onclick="window.location='book_inquire.jsp';" /></td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </td>
