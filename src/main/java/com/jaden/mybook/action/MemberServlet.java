...
import com.jaden.mybook.bean.Member;
import com.jaden.mybook.bean.MemberType;
import com.jaden.mybook.bean.Record;
import com.jaden.mybook.biz.MemberBiz;
import com.jaden.mybook.biz.MemberTypeBiz;
import com.jaden.mybook.biz.RecordBiz;
...
//                double  balance2 = Double.parseDouble(req.getParameter("balance"));
                ...
                //现有账户加入=原金额+现有金额--->不使用该表单，不修改
//                memberBiz.modifyBalance(idNumber2,balance2);
                int count3 = memberBiz.modify(memberId,name2,pwd2,memberTypeId2,tel2,idNumber2);
                //纠正
                if(count3>0){
            ...
            case "modifyrecharge":
                ...
                double count4 = memberBiz.modifyBalance(idNumber3,amount);
                if(count4>0){
